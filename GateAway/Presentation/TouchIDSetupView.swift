                    ...
                    if !isTouchIDEnabled {
                        ...
                        GroupBox {
                            VStack(alignment: .leading, spacing: 12) {
                                ...
                                Text("OpenVPN requires administrator privileges to configure network routing. Instead of typing your password every time, you can use Touch ID for a faster, more secure experience.")
                                    .font(.caption)
                        ...
                        GroupBox {
                            VStack(spacing: 12) {
                                ...
                                Text("You can now use Touch ID when connecting to VPN servers instead of typing your password.")
                                    .font(.caption)
                                    .foregroundColor(.secondary)
