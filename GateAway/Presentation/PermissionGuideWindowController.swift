...
final class PermissionGuideWindowController: NSWindowController {
  ...
  func show(completion: @escaping (Bool) -> Void) {
    guard
      let hosting = window?.contentViewController
        as? NSHostingController<PermissionGuideContentView>
    else { return }
      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 16) {
          InstructionStepView(
            ...
            description:
              "When you click 'Continue', macOS will ask for permission to control Tunnelblick.",
          ...
          InstructionStepView(
            ...
            description:
              "This allows GateAway to automatically connect and disconnect VPN servers.",
          ...
          InstructionStepView(
            ...
            title: "You're done!",
            description:
              "This permission only needs to be granted once. You can manage it later in System Settings.",
